...
public static class EventManager 
{
    ...
    public static event UnityAction<string,string> OnPlayerJoin;
    ...
    public static void PlayerJoin(string name, string properties) => OnPlayerJoin?.Invoke(name,properties);
